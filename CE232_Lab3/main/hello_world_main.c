...
esp_err_t esp_ble_gap_start_advertising(esp_ble_adv_params_t *ble_adv_params);
...
static uint8_t adv_raw_data[31] = {0x02,0x01,0x06,0x09,0x09,0x4C,0x41,0x42,0x33,0x00,
								   0x00,0x00,0x00,0x11,0xFF,0x01,0x08,0x05,0x02,0x00,
								   0x09,0x06,0x06,0x01,0x08,0x05,0x02,0x01,0x03,0x09,0x03};
// GAP callback
...
void app_main() {
	...
	ESP_ERROR_CHECK(esp_ble_gap_config_adv_data_raw(adv_raw_data, 31));
